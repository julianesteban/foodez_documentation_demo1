...
our mobile application. For these reasons, unit testing, integration testing, and data collection scripts and folders are 
not part of our submitted documentation and are marked with a "..._NOTAPPLICABLE" designation in the sub-folder screen.
Consequently, we ask that the points be reallocated to the code and documentation sections of this demo 1 
documents submission. Thank you very much for your time, we hope you enjoyed our demo.
